            ...
            'vi'    => [
                [
                    ...
                    'content' => Html::tag('div', '[simple-slider key="slider-trang-chu"][/simple-slider]') .
                        ...
                        Html::tag('div', '[product-blocks featured_product_title="Nổi bật" top_rated_product_title="Xếp hạng cao nhất" on_sale_product_title="Đang khuyến mãi"][/product-blocks]') .
                        Html::tag('div',
                            '[featured-brands title="Thương hiệu"][/featured-brands]') .
                        Html::tag('div', '[featured-news title="Tin tức" subtitle="Blog của chúng tôi cập nhật các xu hướng mới nhất của thế giới thường xuyên"][/featured-news]') .
                        Html::tag('div', '[testimonials title="Nhận xét từ khách hàng!"][/testimonials]') .
                        Html::tag('div', '[our-features icon1="flaticon-shipped" title1="Miễn phí vận chuyển" subtitle1="Giao hàng miễn phí cho tất cả các đơn đặt hàng tại Hoa Kỳ hoặc đơn hàng trên $200" icon2="flaticon-money-back" title2="Đảm bảo hoàn trả trong 30 ngày" subtitle2="Chỉ cần trả lại nó trong vòng 30 ngày để đổi" icon3="flaticon-support" title3="Hỗ trợ trực tuyến 27/4" subtitle3="Liên hệ với chúng tôi 24 giờ một ngày, 7 ngày một tuần"][/our-features]') .
                        Html::tag('div', '[newsletter-form title="Theo dõi bản tin ngay bây giờ" subtitle="Đăng ký ngay để cập nhật các chương trình khuyến mãi."][/newsletter-form]')
                    ,
                    'template' => 'homepage',
                ],
                [
