...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        Route::group(['prefix' => 'products', 'as' => 'products.'], function () {
            ...
            Route::get('create-fps', [
                'as'         => 'create-fps',
                'uses'       => 'ProductController@createFps',
                'permission' => 'products.create',
            ]);

            Route::post('create-fps', [
                'as'         => 'create-fps.store',
    ...
    Route::group(['prefix' => 'ecommerce'], function () {
        Route::group(['prefix' => 'ajax/products', 'as' => 'ajax.products.'], function () {

            Route::get('framebuilder', [
                'as'         => 'framebuilder',
                'uses'       => 'ProductController@ajaxFramebuilder',
            ]);
        });
