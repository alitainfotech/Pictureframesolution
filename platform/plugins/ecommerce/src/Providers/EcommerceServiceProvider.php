...
use Botble\Ecommerce\Models\ProductSize;
...
use Botble\Ecommerce\Repositories\Caches\ProductSizeCacheDecorator;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(ProductSizeInterface::class, function () {
            return new ProductSizeCacheDecorator(
                new ProductSizeRepository(new ProductSize)
            );
        });
    ...
    public function boot()
    {
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    'id'          => 'cms-plugins-ecommerce.sizes',
                    'priority'    => 200,
                    'parent_id'   => 'cms-plugins-ecommerce',
                    'name'        => 'plugins/ecommerce::framebuilder.sizes',
                    'icon'        => 'fas fa-tools',
                    'url'         => route('ecommerce.sizes'),
                    'permissions' => ['ecommerce.sizes'],
                ])
                /*->registerItem([
