...
use Botble\Ecommerce\Enums\ProductTypeOptionEnum;
...
class ProductFpsForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $productAttributeSets = app(ProductAttributeSetInterface::class)->getAllWithSelected($productId, 'framebuilder');
            ...
            $this
                ...
                ->addMetaBoxes([
                    'general'    => [
                        ...
                        'content'        => view('plugins/ecommerce::products.partials.general-fps',
                            [
