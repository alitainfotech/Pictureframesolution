...
use Botble\Ecommerce\Forms\ProductFpsForm;
...
class ProductController extends BaseController
{
     ...
     * @return string
     */
    public function createFps(FormBuilder $formBuilder)
    {
        page_title()->setTitle(trans('plugins/ecommerce::products.create_framebuilder'));
        ...
        return $formBuilder->create(ProductFpsForm::class)->renderForm();
    }
    ...
    public function edit($id, Request $request, FormBuilder $formBuilder)
    {
        ...
        if($product->type == 'framebuilder'){
          return $formBuilder
            ->create(ProductFpsForm::class, ['model' => $product])
            ->renderForm();
        }
    ...
    /**
     * @param ProductSizeInterface $productSizeInterface
     * @param ProductInterface $productInterface
     * @return BaseHttpResponse
     */
    public function ajaxFramebuilder(BaseHttpResponse $response, ProductSizeInterface $productSizeInterface, ProductInterface $productInterface)
    {
        $sizes = $productSizeInterface
          ...
          $products = $productInterface->getFrameProducts();


          return $response->setData(compact('sizes', 'products'));
    }
}
