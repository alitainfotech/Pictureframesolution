<script id="product_attribute_template" type="text/x-custom-template">
    <li data-id="__id__" class="clearfix">
        ...
        <div class="swatch-title">
            <input type="text" class="form-control" value="__title__" width="150">
        </div>
        <div class="swatch-description">
            <input type="text" class="form-control" value="__description__">
        </div>
...
<div class="swatches-container">
    <div class="header clearfix">
        ...
        <div class="swatch-title">
          Attribute {{ trans('plugins/ecommerce::product-attribute-sets.title') }}
        </div>
        <div class="swatch-description">
            {{ trans('plugins/ecommerce::product-attribute-sets.description') }}
        </div>
        <div class="swatch-slug">
        ...
        @if (count($attributes) > 0)
            @foreach($attributes as $attribute)
                <li data-id="{{ $attribute['id'] }}" class="clearfix">
                    ...
                    <div class="swatch-description">
                        <input type="text" class="form-control" value="{{ $attribute['description'] }}">
                    </div>
                    <div class="swatch-slug">
