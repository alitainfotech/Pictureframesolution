...
mix
    ...
    .copyDirectory([source + '/public/css/style.css'] , public + '/css')
    .copyDirectory([source + '/public/js/app.js', source + '/public/js/scripts.js', source + '/public/js/backend.js', source + '/public/js/icons-field.js'], public + '/js');
