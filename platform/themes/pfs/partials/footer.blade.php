<?php Menu::addMenuLocation('footer_links', 'Description here'); ?>
        ...
        <div class="bottom_footer border-top-tran">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        {!! Menu::renderMenuLocation('footer-links', ['view' => 'footer-links', 'options' => ['class' => 'footer_links text-center']]) !!}
                    </div>
    ...
    @if( App::isLocal() )
      {!! Theme::asset()->container('footer-local')->scripts(); !!}
    @else
      <script src="{{ asset(mix("js/bundle.js")) }}"></script>
    @endif
