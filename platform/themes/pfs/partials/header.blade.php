...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        @if( App::isLocal() )
          {!! Theme::asset()->container('local-header')->styles(); !!}
        @else
          <link media="all" type="text/css" rel="stylesheet" href="{{ asset(mix("css/bundle.css")) }}">
        @endif
