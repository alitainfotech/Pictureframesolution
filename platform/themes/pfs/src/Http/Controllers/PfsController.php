...
namespace Theme\Pfs\Http\Controllers;
...
use Theme;
use Theme\Pfs\Http\Resources\BrandResource;
use Theme\Pfs\Http\Resources\PostResource;
use Theme\Pfs\Http\Resources\ProductCategoryResource;
use Theme\Pfs\Http\Resources\ReviewResource;
use Theme\Pfs\Http\Resources\TestimonialResource;

class PfsController extends PublicController
{
    /**
